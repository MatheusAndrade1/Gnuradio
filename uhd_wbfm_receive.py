...
class uhd_wbfm_receive(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, freq=93.3e6, gain=0, samp_rate=400e3):
        ...
        self.audio_sink = audio.sink(int(samp_rate/audio_decim), '', True)
        ...
        self.connect((self.blocks_multiply_const_vxx, 0), (self.blocks_null_sink_0, 0))
...
def argument_parser():
    ...
    parser.add_argument(
        "-f", "--freq", dest="freq", type=eng_float, default="93.3M",
